...
export namespace Prisma {
  ...
  */
  ...
  export type AuthOutboxOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "aggregateType" | "aggregateId" | "payload" | "createdAt", ExtArgs["result"]["authOutbox"]>
  ...
  interface AuthOutboxFieldRefs {
    ...
    readonly aggregateId: FieldRef<"AuthOutbox", 'Int'>
  ...
  export type AuthOutboxWhereInput = {
    ...
    aggregateId?: IntFilter<"AuthOutbox"> | number
  ...
  export type AuthOutboxScalarWhereWithAggregatesInput = {
    ...
    aggregateId?: IntWithAggregatesFilter<"AuthOutbox"> | number
