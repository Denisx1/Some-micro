...
import { PublicUser } from "@app/common/contracts/user/user.grpc.types";

@QueryHandler(FindPublicUserQuery)
export class FindPublicUserHandler
  implements IQueryHandler<FindPublicUserQuery>
{
  constructor(
    private readonly userRepository: UserRepository
  ) // private readonly userRoleRepository: UserRoleRepository
  {}
  async execute(query: FindPrivateUserQuery): Promise<PublicUser> {
    ...
    return new UserBuilder(user).BuldForPublic();
  }
}
